...
<title>${searchvalue }_二手街搜索</title>
			...
			<div class="row">
			  ...
			  <div class="col-md-9">
			    <div class="dreamcrub">
                    ...
                    <li class="home">&nbsp;
                       	<a href="${pageContext.request.contextPath }/XSearch?searchvalue=${searchvalue }">${searchvalue }</a>&nbsp;
			   ...
			   <div class="mens-toolbar" style="background-color: #fff;border-width: 1px;border-bottom-style: groove;border-top-style: ridge;font-size: 0.8em;">
               	...
               	<div style="border-bottom-width: 1px;border-bottom-style:dotted;padding-bottom: 5px;padding-top: 5px;">
               	   <span>已使用时间：</span>
               	   <span><a href="">一个月</a></span>
               	   <span><a href="">两个月</a></span>
               	   <span><a href="">半年</a></span>
               	   <span><a href="">一年</a></span>
               	   <span><a href="">两年</a></span>
               	</div>
               	<div style="padding-bottom: 5px;padding-top: 5px;">
               	   <span>价格：</span>
               	   <span><a href="">从低到高</a></span>
               	   <span><a href="">从高到低</a></span>
               	</div>
               	<div class="clearfix"></div>
			   </div>-->
			   <!--end 条件搜索 -->
        	 ...
        	 <div class="holder"></div>
					...
					<c:forEach items="${prolist }" var="pro">
					  <li class="simpleCart_shelfItem">
							<a class="cbp-vm-image" href="XProductInfo?proId=${pro.proId }" target="_blank" title="${pro.title }">
							<div class="inner_content clearfix">
								<div class="product_image" style="height: 180px;">
									<c:if test="${fn:length(fn:split(pro.photoAddr,',') )>1 }">
										<img src="${fn:substringBefore(pro.photoAddr,',')}" class="img-responsive"  style="height: 100%;width: 100%"/>	
										</c:if>
										<c:if test="${!fn:contains(pro.photoAddr, ',') }">
										<img src="${pro.photoAddr }" class="img-responsive" alt="" style="height: 100%;width: 100%"/>	
										</c:if>
								  </div>
			                </div>
		                    </a>
							<div class="cbp-vm-details" style="width: 100%;font-size: 1em;">
							<span class="amount item_price actual" style="float: none;">￥${pro.dprice }</span><br>
							<div class="cart-left">
							<a href="XProductInfo?proId=${pro.proId }" target="_blank" title="${pro.title }"><span class="title">${pro.title }</span></a><br>
						    </div>
						    <div class="">
							<span class="title">发布时间：${fn:substring(pro.bdate ,0,11)}</span>
						    </div>
						    <div id="showinfodiv" class="showinfodiv" name="showinfodiv" style="display:none;width: 80%;">
						    <span class="title">商品描述：${pro.details }</span><hr>
						    <span class="title">标签:
						    <c:forTokens items="${pro.tagName }" var="obj" delims=",">
