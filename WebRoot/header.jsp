			...
			<div class="bannertop_box">
			   ...
			   <div class='clearfix'></div>
   		 	...
   		 	<div class="banner_right">
   		 		<form action="XSearch" method="get">
   		 		<div class="search">
   		 		<c:if test="${!empty searchvalue}">
	  			   <input name="searchvalue" type="text" value="${searchvalue }" onfocus="if (this.value != '') {this.value = '';}"  onBlur="if (this.value == '') {this.value = '${searchvalue }';}">
	  			 </c:if>
	  			 <c:if test="${empty searchvalue}">
	  			   <input name="searchvalue" type="text" value="书" onfocus="if (this.value != '') {this.value = '';}" onBlur="if (this.value == '') {this.value = '书';}">
	  			 </c:if>
