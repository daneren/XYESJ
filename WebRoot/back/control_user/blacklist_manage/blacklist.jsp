...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 用户管理 <span class="c-gray en">&gt;</span> 黑名单管理  <span class="c-gray en">&gt;</span>黑名单表<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td>1</td>
                <td><u style="cursor:pointer" class="text-primary" onclick="member_show('张三','blacklist.jsp','10001','360','400')">张三</u></td>
                <td>2016/06/26</td>
            ...
            <tr class="text-c">
                <td><input type="checkbox" value="1" name=""></td>
                <td>2</td>
                <td><u style="cursor:pointer" class="text-primary" onclick="member_show('李四','blacklist.jsp','10001','360','400')">张三</u></td>
                <td>2016/06/26</td>
                <td class="td-status"><span class="label label-defaunt radius">已停用</span></td>
            </tr>
            </tbody>
            ...
            <tr class="text-c">
                <td><input type="checkbox" value="1" name=""></td>
                <td>3</td>
                <td><u style="cursor:pointer" class="text-primary" onclick="member_show('王五','blacklist.jsp','10001','360','400')">张三</u></td>
                <td>2016/06/26</td>
                <td class="td-status"><span class="label label-defaunt radius">已停用</span></td>
            </tr>
            </tbody>
