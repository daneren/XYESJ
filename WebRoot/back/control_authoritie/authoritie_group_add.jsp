	...
	<div class="row cl" >
			<label class="form-label col-2">权限组名称：</label>
				<div class="formControls col-8">
					<input type="text" class="input-text" value="" placeholder="" id="name" name="user-name" datatype="*4-16" nullmsg="用户账户不能为空"></div>
				</div>
...
<script type="text/javascript">
	...
	function SendAJAX(){
	    ...
	    var ajax = createAJAX();
	    var method = "GET";
	    var url = "${pageContext.request.contextPath}/back/control_authoritie/Authoritie_GroupAddServlet?name="+name+"&menu="+str+"&time="+new Date().getTime();
