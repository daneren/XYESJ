...
public class UserDemandChangeStateServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		userdemandsBean.setState(request.getParameter("state"));

		UserdemandsBeanService service=new UserdemandsBeanServiceImpl();
		
		flag = service.changeUserdemandsState(userdemandsBean);
