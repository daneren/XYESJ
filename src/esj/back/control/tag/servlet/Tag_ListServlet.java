...
public class Tag_ListServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<TagsBean> list = service.findAllTags();
		
		request.setAttribute("list", list);

		request.getRequestDispatcher("/back/control_tag/tag_list.jsp").forward(request, response);
	}
