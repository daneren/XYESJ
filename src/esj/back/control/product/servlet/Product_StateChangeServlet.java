...
public class Product_StateChangeServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		productsBean.setState(request.getParameter("state"));
		...
		flag = service.changeProductsState(productsBean);
