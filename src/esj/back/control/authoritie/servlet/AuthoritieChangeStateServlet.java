...
public class AuthoritieChangeStateServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		authoritiesBean.setState(request.getParameter("state"));
		...
		flag = service.updateStateAuthoritiesByID(authoritiesBean);
