...
public class admin_rnoteschangestateServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public admin_rnoteschangestateServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		RnotesBean rnotesBean = new RnotesBean();
		rnotesBean.setReplyId(id+"");
		rnotesBean.setState(state);
		RnotesBeanDao service = new RnotesBeanDaoimpl();
		flag = service.changeRnotesState(rnotesBean);
		if (flag == 1) {
			String msg = null;
