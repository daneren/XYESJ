...
public class BDealingServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		pBeans = pBeanService.getBuyerDealing(userId);
		request.setAttribute("uDeal", pBeans);
		request.getRequestDispatcher("person_bdeal.jsp").forward(request, response);
	}
